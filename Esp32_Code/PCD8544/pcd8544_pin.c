...
static const pcd8544_spi_pin_config_t spi_native_pin[3] = {
    {
        ...
        .sclk_io_num = 5, 		// Mark-Toy mod:  was 14,
        .miso_io_num = 16,		// Mark-Toy mod:  was 13,
        .mosi_io_num = 17,		// Mark-Toy mod:  was 12,
        .spics_io_num = 18,     // Mark-Toy mod:  was 15,
    }, {
        .sclk_io_num = 18,
        .miso_io_num = 23,
        .mosi_io_num = 19,
...
static const pcd8544_control_pin_config_t pcd8544_default_control_pin = {
    .reset_io_num = 26,			// Mark-Toy mod:
    .dc_io_num = 25,
    .backlight_io_num = 15,		// Mark-Toy mod:
};
